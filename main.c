...
int main( int argc, char * argv[])
{
	...
	switch(ch)
	{
		...
		/*Call Subtraction Function*/
			if(big_num == 1)
			{
				if (do_subtraction(head1,tail1,head2,tail2,&headR,&tailR) == SUCCESS)
				{
			...
			{
				if(do_subtraction(head2,tail2,head1,tail1,&headR,&tailR) == SUCCESS)
				{
					printf("Subtraction successfully done.\n");
				}
				else
		...
		/*Call Multilication Function*/
			if(do_multiplication(head1,tail1,head2,tail2,&headR,&tailR) == SUCCESS)
			{
